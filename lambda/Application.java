...
public class Application {
    public static void main(String[] args) {
        ...
        persons.add(new Person("Viet Anh",17));
        ...
        //su dung lambda de sap xep theo ten voi phuong thuc compareByName
        Collections.sort(persons,((o1,o2)->Person.compareByName(o1,o2)));
        show(persons);
        //liet ke nhung nguoi tren 30 tuoi. Khong su dung lambda expression
        System.out.println("Danh sach nhhung nguoi tren 30 tuoi la:");
        for (Person person:persons) {
            if (person.getAge() >30){
                System.out.println(person);
            }
        }
        //liet ke nhung nguoi tren 30 tuoi su dung lambda expression
